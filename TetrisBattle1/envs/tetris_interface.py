...
from TetrisBattle1.settings import *

from TetrisBattle1.tetris import Tetris, Player, Judge, get_infos, freeze

from TetrisBattle1.renderer import Renderer
...
class TetrisInterface(abc.ABC):
    ...
    def reset(
        self, avatar1_path=None, avatar2_path=None, name1=None, name2=None, fontsize=40
    ):
        ...
        self.renderer.drawAvatar(
            img_path1=avatar1_path,
            img_path2=avatar2_path,
            name1=name1,
            name2=name2,
            fontsize=fontsize,
        )
